package cn.wgh.apache.commons.lang;
...
public class StringUtilsDemo {
	...
	public void testName() throws Exception {
		...
		String str8 = StringUtils.chomp(str7);//去除str7尾部的换行符
		System.out.println("去除str7尾部的换行符后,str8: " + str8);
		...
		String padding = StringUtils.repeat("=", 50);//padding:==================================================
		String msg = StringUtils.center(" Customised Header ", 50, "%");//msg:%%%%%%%%%%%%%%% Customised Header %%%%%%%%%%%%%%%%
